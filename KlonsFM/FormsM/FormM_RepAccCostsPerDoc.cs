...
namespace KlonsFM.FormsM
{
    public partial class FormM_RepAccCostsPerDoc : MyFormBaseF
    {
        ...
        public void MakeReport()
        {
            ...
            var ad = new DataSets.KlonsMRepDataSetTableAdapters.SP_M_REP_COSTACC_2TableAdapter();
            var table = ad.GetDataBy_SP_M_REP_COSTACC_2(Date1, Date2);
            if (table.Count == 0)
            {
        ...
        private void dgvRows_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
                ...
                e.ColumnIndex == dgcIdStoreOut.Index)
            {
                ...
                var dr_store = MyData.DataSetKlonsM.M_STORES.FindByID(idstore);
