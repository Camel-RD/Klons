...
{
    public partial class FormM_Docs : MyFormBaseF, 
        IMyDgvTextboxEditingControlEvents2, IMyDgvTextboxEditingControlEvents
    {
        ...
        private void FormM_Docs_Load(object sender, EventArgs e)
        {
            CheckEnableRows();
            CheckSave();
            dgvDocs.Focus();
        ...
        private void FormM_Docs_FormClosed(object sender, FormClosedEventArgs e)
        {
            MyData.DataSetKlonsM.M_DOCS.ColumnChanged -= M_DOCS_ColumnChanged;
            MyData.DataSetKlonsM.M_ROWS.ColumnChanged -= M_ROWS_ColumnChanged;
