...
using KlonsLIB.Misc;
using LOPSdTableAdapter = KlonsFM.DataSets.klonsDataSetTableAdapters.LOPSDTableAdapter;
using LOPSTableAdapter = KlonsFM.DataSets.klonsDataSetTableAdapters.LOPSTableAdapter;
