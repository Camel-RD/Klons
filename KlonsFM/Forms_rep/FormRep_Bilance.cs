...
namespace KlonsFM.Forms
{
    public partial class FormRep_Bilance : MyFormBaseF
    {
        ...
        public List<RepRow_BalMT> PrepareReportMt_apgr(string balid, KlonsFM.DataSets.klonsRepDataSet.SP_REP_BAL_22DataTable table)
        {
        ...
        public List<RepRow_BalMT> PrepareReportMt_atl(string balid, KlonsFM.DataSets.klonsRepDataSet.SP_REP_BAL_22DataTable table)
        {
            var ret = new List<RepRow_BalMT>();
            foreach (var dr in table)
            {
