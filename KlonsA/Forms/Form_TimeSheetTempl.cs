...
{
    public partial class Form_TimeSheetTempl : MyFormBaseA
    {
        public Form_TimeSheetTempl()
        {
            InitializeComponent();
        ...
        private void Form_TimeSheetTempl_Load(object sender, EventArgs e)
        {
            ...
            MyData.DataSetKlons.TIMESHEET_TEMPL_R.ColumnChanged += TIMESHEET_TEMPL_R_ColumnChanged;
        ...
        private void TIMESHEET_TEMPL_R_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            if (e.Column == MyData.DataSetKlons.TIMESHEET_TEMPL_R.IDPColumn)
            {
        ...
        public void GetIDDepFromDialog()
        {
            ...
            var ret = fm.ShowMyDialogModal();
            if (ret != DialogResult.OK) return;
            var dr = (dgvShL.CurrentRow.DataBoundItem as DataRowView).Row as KlonsADataSet.TIMESHEET_TEMPLRow;
        ...
        private void RenumRows()
        {
            ...
            {
                var dr = (bsShR[i] as DataRowView).Row as KlonsADataSet.TIMESHEET_TEMPL_RRow;
