...
{
    public partial class Form_PayListsTempl : MyFormBaseA
    {
        public Form_PayListsTempl()
        {
            InitializeComponent();
        ...
        {
            MyData.DataSetKlons.PAYLIST_TEMPL_R.ColumnChanged += PAYLIST_TEMPL_R_ColumnChanged;
            CheckEnableGrid();
            CheckSave();
        }

        private void Form_PayListsTempl_FormClosed(object sender, FormClosedEventArgs e)
        {
            MyData.DataSetKlons.PAYLIST_TEMPL_R.ColumnChanged -= PAYLIST_TEMPL_R_ColumnChanged;
        }

        private void PAYLIST_TEMPL_R_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            if(e.Column == MyData.DataSetKlons.PAYLIST_TEMPL_R.IDPColumn)
            {
        ...
        private void SelectCurrent()
        {
            ...
            var dr = bsShL.CurrentDataRow as KlonsA.DataSets.KlonsADataSet.PAYLIST_TEMPLRow;
        ...
        public void GetIDPFromDialog()
        {
            ...
            var dr = (dgvShR.CurrentRow.DataBoundItem as DataRowView).Row as KlonsADataSet.PAYLIST_TEMPL_RRow;
        ...
        public void GetIDDepFromDialog()
        {
            ...
            var ret = fm.ShowMyDialogModal();
            if (ret != DialogResult.OK) return;
            var dr = (dgvShL.CurrentRow.DataBoundItem as DataRowView).Row as KlonsADataSet.PAYLIST_TEMPLRow;
        ...
        {
            dgvShR.Enabled = !(dgvShL.CurrentRow == null || 
