...
{
    public partial class Form_StartUp : MyFormBaseA
    {
        public Form_StartUp()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (UpgradeHelper.HasUpgrade(v, MyData.Version))
                {
                    var ret = MyMessageBox.Show(
                        ...
                        , "Jauna versija!", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                ...
                MyMainForm.Text = "Klons-A.Net: " + MyData.Settings.MasterEntry.Descr.Nz();
