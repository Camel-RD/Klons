...
{
    public class ToolStripPickTextBox : ToolStripTextBox
    {
        ...
        private void ControlOnBindingContextChanged(object sender, EventArgs eventArgs)
        {
            this.tryDataBinding();
        }
        ...
        */
        ...
        private void tryDataBinding()
        {
            if (this.DataSource == null ||
                base.Control.BindingContext == null)
                return;
            ...
            {
                cm = (CurrencyManager)
                      base.Control.BindingContext[this.DataSource,
                                          this.DataMember];
            }
